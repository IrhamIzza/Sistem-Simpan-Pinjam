        ...
        <div class="d-flex">
            ...
            <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown">
                    ...
                    <span class="avatar" style="background-image: url(https://randomuser.sme/api/portraits/men/43.jpg)"></span>
                    <span class="ml-2 d-none d-lg-block">
                        <span class="text-default">{{ Auth::user()->name }}</span>
                        <span class="text-muted d-block mt-1">{{ Auth::user()->email }}</span>
                    </span>
                    </a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('withdrawals.index') }}" class="nav-link"><i class="fe fe-printer" aria-hidden="true"></i> {{ __('menu.loan') }}</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('home') }}" class="nav-link"><i class="fe fe-home" aria-hidden="true"></i> {{ __('menu.financialstatements') }}</a>
                    </li>
                    <li class="nav-item">
